 ...
 * preconfigured to emulate the iPad Generation 6 device.
 * <p>
 ...
 * @since 1.0.0
 */
public class iPadGen6Context {

	private iPadGen6Context() {}

    public static Browser.NewContextOptions iPad_gen_6() {
